...
class Config:
    ...
    MAIL_USERNAME = os.getenv("MAIL_USERNAME", "8b4ca1001@smtp-brevo.com")
    MAIL_PASSWORD = os.getenv("MAIL_PASSWORD", "P1r4DvZdMGFhk8Kc")
    MAIL_DEFAULT_SENDER = os.getenv("MAIL_DEFAULT_SENDER", "mspurushothama20@gmail.com")
